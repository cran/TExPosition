...
#' or examples:\cr Derek Beaton, Jenny Rieck, Cherise Chin-Fatt, Francesca
#' Filbey, Ju-Chi Yu, Luke Moraglia, and Hervé Abdi.
#' @seealso \code{\link{tepBADA}}, \code{\link{tepPLS}}, \code{\link{tepDICA}},
#' \code{\link{tepPLSCA}}
...
#' Research Design}. Thousand Oaks (CA): Sage. pp. 64-75. \cr Abdi, H. (2007).
...
#' review. \emph{NeuroImage}, \emph{56}(\bold{2}), 455 -- 475.\cr McIntosh, A.
